	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper i, {{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper svg, {{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper img'   => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper i, {{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper svg, {{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper img'   => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
