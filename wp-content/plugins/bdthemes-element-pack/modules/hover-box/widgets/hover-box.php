	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-hover-box .bdt-icon-wrapper i, {{WRAPPER}} .bdt-hover-box .bdt-icon-wrapper svg'   => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-hover-box .bdt-hover-box-item:hover .bdt-icon-wrapper i, {{WRAPPER}} .bdt-hover-box .bdt-hover-box-item:hover .bdt-icon-wrapper svg'   => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
