...
class Tabs extends Module_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_background',
            [
                'label' => __('Section Background', 'bdthemes-element-pack') . BDTEP_NC,
                'condition' => [
        ...
        $this->add_control(
            'section_bg_selector',
            [
                'label'       => __('Section ID / Class', 'bdthemes-element-pack'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active'  => true,
                ],
                'description' => __('Enter your Section ID/Class. Example #sec-1, .sec-1', 'bdthemes-element-pack'),
            ]
        );
        ...
        $repeater->add_control(
            'section_bg',
            [
                'label' => __('Select Background', 'bdthemes-element-pack'),
