	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card .bdt-icon-wrapper svg' => 'fill: {{VALUE}};', 
				],
				'condition' => [
					'icon_type!' => 'image',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-icon-wrapper i, {{WRAPPER}} .bdt-fancy-card .bdt-icon-wrapper svg, {{WRAPPER}} .bdt-fancy-card .bdt-icon-wrapper img' => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'icon_type!' => 'image',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'  => 'after',
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper, {{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper i, {{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper svg, {{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper img'   => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole svg' => 'fill: {{VALUE}};',
				],
			]
		);
