...
class AdvancedHeading extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-advanced-heading .bdt-button-icon-align-right'  => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-ep-advanced-heading .bdt-button-icon-align-left'   => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-ep-advanced-heading .bdt-button-icon-align-bottom' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Text Stroke (Deprecated)', 'bdthemes-element-pack') . BDTEP_NC,
				'type'    => Controls_Manager::SWITCHER,
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'  => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-advanced-heading-main-title-inner' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'  => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-advanced-heading-content > div' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
	...
	protected function render() {
		...
		if ($settings['sub_heading']) {
			...
			$sub_heading = '<div class="bdt-ep-advanced-heading-sub-title"><div class="bdt-ep-advanced-heading-sub-title-content">'.$settings['sub_heading'].'</div>'.$subh_style.'</div> ';
		}
	...
	protected function content_template() {
		...
		view.addRenderAttribute( 'main_heading', 'class', 'bdt-ep-advanced-heading-main-title-inner' );
		...
		view.addRenderAttribute( 'main_heading_wrapper', 'class', [ 'bdt-ep-advanced-heading-title', 'elementor-size-' + settings.size ] );

		view.addRenderAttribute('advanced_heading_content', 'class', ['bdt-ep-advanced-heading-content'] );
		...
		<div class="bdt-ep-advanced-heading">
			...
			<{{headerSizeTag}} <# print(view.getRenderAttributeString( 'main_heading_wrapper' )) #> >
				<span class="bdt-ep-advanced-heading-main-title">
