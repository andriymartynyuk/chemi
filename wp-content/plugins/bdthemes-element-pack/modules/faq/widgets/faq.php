...
class FAQ extends Module_Base {
    ...
    public function render_more_button_button($post) {
        ...
        if ( 'yes' == $settings['show_read_more'] ) : ?>
            ...
            <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"
               class="bdt-faq-button<?php echo esc_attr($animation); ?>"><?php echo esc_html($settings['more_button_button_text']); ?>
    ...
    public function render_filter_menu() {
        ...
        <div class="bdt-ep-grid-filters-wrapper"
             id="<?php echo 'bdt-faq-' . $this->get_id(); ?>" <?php echo $this->get_render_attribute_string('bdt-faq-hash-data'); ?>>
        ...
        while ( $wp_query->have_posts() ) {
            ...
            if ( 'yes' != $settings["multicolumns"] ) {
                ...
                if ( $count == 0 ) {
                    ...
                    echo '</div><div ' . $this->get_render_attribute_string('accordion-settings') . '>';
                    $this->render_post($settings);
                } elseif ( $count > $half_item ) {
                    $this->render_post($settings);
