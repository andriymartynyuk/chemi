...
<!--                             <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 order-md-0 order-1 pt-5 pt-md-4 pt-lg-0"> -->
							<div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 order-md-0 order-1 pt-lg-0">  <!--Manually Edited  -->
                                <?php get_sidebar(); ?>
                            </div> 
                        </div><!--//row  -->
                             ...
                             <div class="post-nav">
                                <?php echo paginate_links( array (
                                    ...
                                    'prev_text'          => __('<i class="fa fa-long-arrow-left" aria-hidden="true"></i>', 'indro'),
                                    'next_text'          => __('<i class="fa fa-long-arrow-right" aria-hidden="true"></i>', 'indro'),
                                )) ; ?>
                            </div>
