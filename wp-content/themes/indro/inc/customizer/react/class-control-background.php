...
/**
 * Class indro_Control_Background
 *
 * @access public
 */
class indro_Control_Background extends WP_Customize_Media_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'indro_background_control';
...
$wp_customize->register_control_type( 'indro_Control_Background' );
