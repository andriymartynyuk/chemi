...
class ResponsiveControl extends Component {
	...
	render() {
		...
		deviceMap = {
			'desktop': {
				'tooltip': __( 'Desktop', 'indro' ),
				'icon': <Icon icon={ Icons.desktop }/>
			},
			'tablet': {
				'tooltip': __( 'Tablet', 'indro' ),
				'icon': <Icon icon={ Icons.tablet }/>
			},
			'mobile': {
				'tooltip': __( 'Mobile', 'indro' ),
	...
	linkResponsiveButtons() {
		let self = this;
		document.addEventListener( 'indroChangedRepsonsivePreview', function(e) {
