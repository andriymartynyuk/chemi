...
class RowLayoutComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			desktop: {
				'column5': {
					'equal': {
						tooltip: __( 'Equal Width Columns', 'indro' ),
						icon: 'fivecol',
					},
				},
				'column4': {
					...
					'left-forty': {
						tooltip: __( 'Left Heavy 40/20/20/20', 'indro' ),
						icon: 'lfourforty',
					},
					'right-forty': {
						tooltip: __( 'Right Heavy 20/20/20/40', 'indro' ),
						icon: 'rfourforty',
					},
				},
				'column3': {
					...
					'left-half': {
						tooltip: __( 'Left Heavy 50/25/25', 'indro' ),
						icon: 'lefthalf',
					},
					'right-half': {
						tooltip: __( 'Right Heavy 25/25/50', 'indro' ),
						icon: 'righthalf',
					},
					'center-half': {
						tooltip: __( 'Center Heavy 25/50/25', 'indro' ),
						icon: 'centerhalf',
					},
					'center-wide': {
						tooltip: __( 'Wide Center 20/60/20', 'indro' ),
						icon: 'widecenter',
					},
				},
				'column2': {
					...
					'left-golden': {
						tooltip: __( 'Left Heavy 66/33', 'indro' ),
						icon: 'twoleftgolden',
					},
					'right-golden': {
						tooltip: __( 'Right Heavy 33/66', 'indro' ),
						icon: 'tworightgolden',
					},
				},
				'column1': {
			...
			mobile: {
				'column5': {
					...
					'row': {
						tooltip: __( 'Collapse to Rows', 'indro' ),
				...
				'column4': {
					...
					'two-grid': {
						tooltip: __( 'Two Column Grid', 'indro' ),
						icon: 'grid',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'indro' ),
				...
				'column3': {
					...
					'first-row': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'indro' ),
						icon: 'firstrow',
					},
					'last-row': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'indro' ),
						icon: 'lastrow',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'indro' ),
	...
	render() {
		...
		return (
			<div className="indro-control-field indro-radio-icon-control indro-row-layout-control">
											...
											<Tooltip text={ controlMap[ item ].tooltip }>
												...
												>
													...
													{ controlMap[ item ].dashicon && (
														<span className="indro-radio-icon indro-radio-dashicon">
	...
	linkColumns() {
		let self = this;
		document.addEventListener( 'indroUpdateFooterColumns', function( e ) {
