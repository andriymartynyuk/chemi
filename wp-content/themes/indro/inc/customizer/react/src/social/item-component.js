			...
			<div className="indro-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="indro-sorter-item-panel-header">
					...
					<span className="indro-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Social Item', 'indro' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="indro-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs indro-social-type"
												...
												<Fragment>
													...
													{ this.props.item.url && (
														<div className="social-custom-image">
															<div className="indro-social-image">
																<img className="indro-social-image-preview" src={ this.props.item.url } />
															</div>
															<Button
