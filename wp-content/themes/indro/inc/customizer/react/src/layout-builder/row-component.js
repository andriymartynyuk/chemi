...
class RowComponent extends Component {
	render() {
		...
		let besideItems = [];
		return (
			<div className={ `indro-builder-areas ${ centerClass }` }>
				<Button
					className="indro-row-left-actions"
					aria-label={ __( 'Edit Settings for', 'indro' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'indro' ) : this.props.row + ' ' + __( 'Row', 'indro' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
					icon="admin-generic"
				>
				</Button>
				<Button
					className="indro-row-actions"
					aria-label={ __( 'Edit Settings for', 'indro' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'indro' ) : this.props.row + ' ' + __( 'Row', 'indro' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
				>
					{ ( this.props.row === 'popup' ? __( 'Off Canvas', 'indro' ) : this.props.row + ' ' + __( 'Row', 'indro' ) ) }
					<Dashicon icon="admin-generic" />
				</Button>
				<div className="indro-builder-group indro-builder-group-horizontal" data-setting={ this.props.row }>
