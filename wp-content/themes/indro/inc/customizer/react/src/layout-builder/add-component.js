...
class AddComponent extends Component {
	...
	render() {
		...
		let classForAdd = 'indro-builder-add-item';
		...
		return (
			<div className={ classForAdd } key={ this.props.id }>
				{ this.state.isVisible && (
					<Popover position="top" className="indro-popover-add-builder" onClose={ toggleClose }>
						<div className="indro-popover-builder-list">
				...
				<Button
					className="indro-builder-item-add-icon"
					onClick={ () => {
