...
class BuilderComponent extends Component {
	...
	focusPanel( item ) {
		if ( undefined !== this.props.customizer.section( 'indro_customizer_' + item ) ) {
			this.props.customizer.section( 'indro_customizer_' + item ).focus();
		}
	}
	focusItem( item ) {
	...
	render() {
		return (
			<div className="indro-control-field indro-builder-items">
				...
				<div className="indro-builder-row-items">
	...
	// linkFocusButtons() {
	// 	this.props.control.container.on( 'click', '.indro-builder-areas .indro-builder-item', function( e ) {
	// 		e.preventDefault();
