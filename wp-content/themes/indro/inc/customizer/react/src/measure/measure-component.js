...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="indro-control-field indro-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="indro-units indro-locked">
							{ this.getResponsiveLockedButtons() }
						</div>
						{ this.controlParams.units && (
							<div className="indro-units">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						...
						<div className="indro-responsive-controls-content">
							{ this.state.locked && (
								<RangeControl
