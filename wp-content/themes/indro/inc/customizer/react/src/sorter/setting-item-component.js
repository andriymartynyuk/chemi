...
class ItemComponent extends Component {
	...
	render() {
		...
		return (
			<div className="indro-sorter-item" data-id={ this.props.item } key={ this.props.item }>
				<div className={ `indro-sorter-item-panel-header ${ ( this.state.item.enabled ? 'panel-item-is-visible' : 'panel-item-is-hidden' ) }` }>
					{ this.props.moveable && ( 
						<span
					...
					<Tooltip text={ __( 'Toggle Item Visibility', 'indro' ) }>
						<Button
							className={ `indro-sorter-visiblity ${ ( this.state.item.enabled ? 'item-is-visible' : 'item-is-hidden' ) }`}
							onClick={ () => {
					...
					<span className="indro-sorter-title">
					...
					{ 'title' !== this.props.item && 'above_title' !== this.props.item && 'category' !== this.props.item && 'description' !== this.props.item && 'readmore' !== this.props.item && 'rating' !== this.props.item && 'product_meta' !== this.props.item && 'share' !== this.props.item && (
						<Tooltip text={ __( 'Expand Item Controls', 'indro' ) }>
							<Button
								className="indro-sorter-item-expand"
								onClick={ () => {
				...
				{ this.state.open && (
					<div className="indro-sorter-item-panel-content">
						{ undefined !== this.state.item.ratio && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Ratio', 'indro' ) }</span>
								<ButtonGroup className="indro-radio-container-control indro-featured-image-ratio">
						...
						{ undefined !== this.state.item.imageLink && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Image is link to post', 'indro' ) }
						...
						{ undefined !== this.state.item.show_title && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Post Title in Breadcrumb?', 'indro' ) }
						...
						{ undefined !== this.state.item.fullContent && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Full Content?', 'indro' ) }
								...
								{ undefined !== this.state.item.words && false === this.state.item.fullContent && (
									<RangeControl
										...
										max={ 125 }
										step={ 1 }
										label={ __( 'Excerpt Word Count', 'indro' ) }
									/>
								) }
							</div>
						) }
						{ undefined !== this.state.item.size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Size', 'indro' ) }</span>
								<SelectControl
						...
						{ undefined !== this.state.item.divider && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Divider', 'indro' ) }</span>
						...
						{ undefined !== this.state.item.button_size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Button Size', 'indro' ) }</span>
								<ButtonGroup className="indro-radio-container-control">
						...
						{ undefined !== this.state.item.style && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Style', 'indro' ) }</span>
								<ButtonGroup className="indro-radio-container-control">
						...
						{ undefined !== this.state.item.show_shipping && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Shipping Statement?', 'indro' ) }
									...
									<Fragment>
										{ undefined !== this.state.item.shipping_statement && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Shipping Excerpt', 'indro' ) }</span>
						...
						{ undefined !== this.state.item.feature_1 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'First Feature', 'indro' ) }
									value={ this.state.item.feature_1 }
									onChange={ ( value ) => {
										this.updateValues( { feature_1: value } );
									} }
								/>
								<span className="sorter-control-title">{ __( 'Choose a Icon', 'indro' ) }</span>
								<ButtonGroup className="indro-radio-container-control">
								...
								{ this.state.item.author && (
									<Fragment>
										{ undefined !== this.state.item.authorLink && (
											<Fragment>
												<ToggleControl
													label={ __( 'Enable Author Link?', 'indro' ) }
										...
										{ undefined !== this.state.item.authorImage && (
											<Fragment>
												<ToggleControl
													label={ __( 'Show Author Image?', 'indro' ) }
												...
												{ undefined !== this.state.item.authorImageSize && true === this.state.item.authorImage && (
													<RangeControl
														...
														max={ 125 }
														step={ 1 }
														label={ __( 'Author Image Size (px)', 'indro' ) }
													/>
												) }
											</Fragment>
										) }
										{ undefined !== this.state.item.authorLabel && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Author Label', 'indro' ) }</span>
												<div className={ `meta-label-input-control ${ ( this.state.item.authorEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
													<Tooltip text={ __( 'Toggle Label Visibility', 'indro' ) }>
														<Button
															className={ `indro-label-visiblity ${ ( this.state.item.authorEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
															onClick={ () => {
						...
						{ undefined !== this.state.item.date && (
							<div className="sorter-sub-option">
								...
								{ undefined !== this.state.item.dateLabel && this.state.item.date && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Date Label', 'indro' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'indro' ) }>
												<Button
													className={ `indro-label-visiblity ${ ( this.state.item.dateEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted on', 'indro' ) }
						...
						{ undefined !== this.state.item.dateUpdated && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __(  'Show Last Updated Date?', 'indro' ) }
								...
								{ undefined !== this.state.item.dateUpdatedLabel && this.state.item.dateUpdated && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Updated Date Label', 'indro' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateUpdatedEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'indro' ) }>
												<Button
													className={ `indro-label-visiblity ${ ( this.state.item.dateUpdatedEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Updated on', 'indro' ) }
						...
						{ undefined !== this.state.item.categories && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __( 'Show Categories?', 'indro' ) }
								...
								{ undefined !== this.state.item.categoriesLabel && this.state.item.categories && this.state.item.metaLabel && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Categories Label', 'indro' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.categoriesEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'indro' ) }>
												<Button
													className={ `indro-label-visiblity ${ ( this.state.item.categoriesEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted in', 'indro' ) }
						...
						{ undefined !== this.state.item.card_color && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Icon Colors', 'indro' ) }</span>
								<ButtonGroup className="indro-radio-container-control">
						...
						{ undefined !== this.state.item.mastercard && (
							<ToggleControl
								label={ __(  'Show Mastercard?', 'indro' ) }
