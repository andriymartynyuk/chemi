...
import indroGradientPicker from './gradient-component.js';
import indroColorPicker from '../common/color-picker';
...
class BackgroundComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			repeat: {
				'no-repeat': {
					name: __( 'No Repeat', 'indro' ),
				},
				'repeat': {
					name: __( 'Repeat', 'indro' ),
				},
				'repeat-x': {
					name: __( 'Repeat-X', 'indro' ),
				},
				'repeat-y': {
					name: __( 'Repeat-y', 'indro' ),
				},
			},
			size: {
				auto: {
				...
				contain: {
					name: __( 'Contain', 'indro' ),
				},
			},
			attachment: {
				scroll: {
					name: __( 'Scroll', 'indro' ),
				},
				fixed: {
					name: __( 'Fixed', 'indro' ),
				},
		...
		const palette = JSON.parse( this.props.customizer.control( 'indro_color_palette' ).setting.get() );
		//console.log( palette );
		this.state = {
			value: value,
	...
	render() {
		...
		const toggleVisible = () => {
			const updateColors = JSON.parse( this.props.customizer.control( 'indro_color_palette' ).setting.get() );
		...
		if( this.state.supportGradient ) {
			tab_options = [
				{
					name: 'color',
					title: __( 'Color', 'indro' ),
					className: 'indro-color-background',
				},
				{
					name: 'gradient',
					title: __( 'Gradient', 'indro' ),
					className: 'indro-gradient-background',
				},
				{
					name: 'image',
					title: __( 'Image', 'indro' ),
					className: 'indro-image-background',
				},
			];
		} else {
			tab_options = [
		...
		return (
			<div className="indro-control-field indro-background-control">
				<ResponsiveControl
					onChange={ ( currentDevice) => this.setState( { currentDevice } ) }
					controlLabel={ controlLabel }
				>
					<div className="indro-background-picker-wrap">
						{ this.state.isVisible && (
							<Popover position="top left" className="indro-popover-color" onClose={ maybeToggleClose }>
								<TabPanel className="indro-popover-tabs indro-background-tabs"
												...
												if ( 'image' === tab.name ) {
													tabout = (
														<Fragment>
															...
															<span className="customize-control-title">{ __( 'Background Repeat', 'indro' ) }</span>
															...
															<span className="customize-control-title">{ __( 'Background Size', 'indro' ) }</span>
															<ButtonGroup className="indro-radio-container-control">
															...
															<span className="customize-control-title">{ __( 'Background Attachment', 'indro' ) }</span>
															<ButtonGroup className="indro-radio-container-control">
													...
													tabout = (
														<Fragment>
															{ this.state.isVisible && this.state.refresh && (
																<div className="indro-background-color-wrap">
																	<indroColorPicker
																		//presetColors={ [] }
						...
						<Tooltip text={ this.controlParams.tooltip ? this.controlParams.tooltip : __( 'Select Background', 'indro' ) }>
							<div className="background-button-wrap">
								<Button className={ 'indro-background-icon-indicate' } onClick={ () => { this.state.isVisible ? toggleClose() : toggleVisible() } }>
									{ ( undefined === this.state.value[ this.state.currentDevice ] || undefined === this.state.value[ this.state.currentDevice ].type || this.state.value[ this.state.currentDevice ].type === 'color' ) && (
										<Fragment>
											<ColorIndicator className="indro-advanced-color-indicate" colorValue={ getColorPreviewValue( this.state.currentDevice ) } />
											...
											{ showGradientPreview( this.state.currentDevice ) &&
												<ColorIndicator className="indro-advanced-color-indicate" colorValue={ getGradientPreviewValue( this.state.currentDevice ) } />
											}
										</Fragment>
									) }
	...
	preventClose() {
		let self = this;
		document.addEventListener( 'indroOpenMediaModal', function(e) {
