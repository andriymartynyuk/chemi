	...
	render() {
		return (
			<div className="indro-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="indro-sorter-item-panel-header">
					...
					<span className="indro-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Contact Item', 'indro' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="indro-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs indro-contact-type"
												...
												<Fragment>
													...
													{ this.props.item.url && (
														<div className="contact-custom-image">
															<div className="indro-Contact-image">
																<img className="indro-Contact-image-preview" src={ this.props.item.url } />
															</div>
															<Button
															...
															>
																{ __( 'Remove Image', 'indro' ) }
																<Dashicon icon='no'/>
															</Button>
														</div>
													) }
													<RangeControl
														label={ __( 'Max Width (px)', 'indro' ) }
						...
						/>
						<Button
							className="indro-sorter-item-remove"
							isDestructive
							onClick={ () => {
								this.props.removeItem( this.props.index );
							} }
						>
							{ __( 'Remove Item', 'indro' ) }
