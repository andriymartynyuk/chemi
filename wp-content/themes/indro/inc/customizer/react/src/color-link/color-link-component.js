...
class ColorLinkComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				'highlight': {
					tooltip: __( 'Initial', 'indro' ),
					palette: true,
				},
				'highlight-alt': {
					tooltip: __( 'Hover', 'indro' ),
					palette: true,
				},
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'indro' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'indro' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'indro' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'indro' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'indro' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'indro' ),
				},
			},
		};
	...
	render() {
		...
		return (
			<Fragment>
				<div className="indro-control-field indro-color-control indro-link-color-control">
